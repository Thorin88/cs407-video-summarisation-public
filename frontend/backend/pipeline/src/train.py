...
from basic_NN.train import train as train_basic_NN
from basic_GRU.train import train as train_basic_GRU
...
TRAINER = {
    ...
    # Added our train.py files for basic_NN and for basic_GRU
