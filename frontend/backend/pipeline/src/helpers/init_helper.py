...
def get_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument('model', type=str,
                        choices=('anchor-based', 'anchor-free', 'feat-anchor-free', 'basic', 'gru'))
    ...
    # Custom
    parser.add_argument('--batchExtract', type=bool, default=False)
    parser.add_argument('--featureFormat', type=str, default='avg1024',
                        choices=['avg2D', 'avg1024D'])
    parser.add_argument('--pipeline-mode', type=str, default='single',
